...
const configuration = {
  ...
  timezones: [
    ...
    {
      iso_3166_1: 'UA',
      zones: ['Europe/Kiev', 'Europe/Uzhgorod', 'Europe/Zaporozhye', 'Europe/Simferopol']
    },
    {
      iso_3166_1: 'UG',
      zones: ['Africa/Nairobi']
...
const store = createStore(rootReducer, { configuration }, composedEnhancers);

// Redux provider decorators
// -----------------------
